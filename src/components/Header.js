    ...
    <div className="container" >
      ...
      <div div className="row" >
        <div className="col-12 col-md-12 text-center">
          <button id="getLatestPosts" className="btn my-1 mx-1">Read Latest News</button>
          <button id="getTopPosts" className="btn my-1 mx-1">Read Top News</button>
          <button id="resetAllNews" className="btn my-1 mx-1">Reset All News</button>
